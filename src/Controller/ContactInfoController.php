...
class ContactInfoController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('contact_info_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('contact_info/new.html.twig', [
    ...
    public function edit(Request $request, ContactInfo $contactInfo): Response
    {
        ...
        return $this->renderForm('contact_info/edit.html.twig', [
            'contact_info' => $contactInfo,
            'form' => $form,
        ]);
    }
